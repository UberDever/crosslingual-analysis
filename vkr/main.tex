...
% 3 страница
% \input{body/0-annotation} % Аннотация

\tableofcontents % Содержание 
\clearpage

\input{body/1-1-scope}
\input{body/1-2-current-state}
\input{body/1-3-requirements}
\input{body/1-4-crosslingual-analysis}
\input{body/0-glossary}     % Перечень сокращений и условных обозначений
\input{body/0-bibliography} % Библиографический список
