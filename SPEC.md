...
Исходные данные к работе: Заинтересованность в выработке метода анализа мультиязыковых текстов программ, нацеленных на интеграцию в различные инструментальные средства программирования.
Содержание работы:
- Теоретико-аналитический раздел
    1. Анализ существующих технологий и языков программирования, предметных областей вовлекаемых в разработку ПО.
    2. Исследование существующих решений в области мультиязыковых анализаторов.
    3. Постановка задачи: определение области анализа, формирование требований к анализатору
    4. Анализ существующих формализмов для выработки теоретической базы анализа, проектирование архитектуры и исследование средств реализации
- Проектный раздел
    1. Описание основных сценариев использования анализатора по отношению к инструментальным средствам
    2. Реализация анализатора и его программной инфраструктуры
    3. Оценка анализатора на избранных тестовых проектах
